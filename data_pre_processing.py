...
#verifico integrità dei dati, controllo se ci sono NA
number_of_na = final_dataframe.isna().sum().sum()
#isna() trasforma in 1 i NaN e 0 gli altri valori. il primo sum() restituisce una sola riga con la somma di ogni colonna
#il secondo sum restituisce la somma di tutte le somme
...
#ciclo che scorre tutte le colonne tranne rating, controllo che non ci siano valori < 0 e > 1
